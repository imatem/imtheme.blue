...
#
#  $ bin/test -s imtheme.blue -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src imtheme.blue.testing.IMTHEME_BLUE_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/imtheme/blue/tests/robot/test_example.robot
#

...
class HiddenProfiles(object):
    ...
    def getNonInstallableProfiles(self):
        ...
        return [
            'imtheme.blue:uninstall',
        ]


def post_install(context):
    """Post install script for infomatem migration"""
    portal = api.portal.get()
    if portal.id != 'infomatem':
        return
    ...
    # new content
    biblio = api.content.create(
        type='Folder', title='Bibliotecas', container=portal)
